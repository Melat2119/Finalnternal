          ...
          <table class="table table-hover align-middle custom-table w-100 mb-0">
            ...
            <tbody>
              <tr v-for="sale in sales" :key="sale.id">
                ...
                <td>
                  <button class="btn btn-sm btn-primary me-1" @click="viewSale(sale)">View</button>
                  <button class="btn btn-sm btn-success me-1" @click="uploadDocument(sale)">Upload</button>
                  <button class="btn btn-sm btn-warning" @click="giveFeedback(sale)">Feedback</button>
                </td>
              </tr>
            </tbody>
          </table>
