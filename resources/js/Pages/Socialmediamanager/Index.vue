        ...
        <table class="table table-hover align-middle custom-table w-100 mb-0">
          ...
          <tbody>
            <tr v-if="!managers || managers.length === 0">
              <td colspan="3" class="text-center text-muted">No managers found.</td>
            </tr>
            <tr v-for="manager in managers" :key="manager.id">
              ...
              <td class="d-flex gap-2">
                <button class="btn btn-sm btn-outline-primary" @click="viewManager(manager)">
                  📄 View Documents
                </button>
                <button class="btn btn-sm btn-outline-success" @click="openEdit(manager)">
                  ✏️ Edit
                </button>
                <button class="btn btn-sm btn-outline-danger" @click="deleteManager(manager)">
                  🗑️ Delete
                </button>
                <button class="btn btn-sm btn-outline-success" @click="uploadDocument(manager)">
                  ⬆️ Upload
                </button>
                <button class="btn btn-sm btn-outline-warning" @click="openFeedback(manager)">
                  💬 Feedback
                </button>
              </td>
            </tr>
